...
const Signup = () => {
  ...
  const submitData = async (event) => {
    ...
    try {
      ...
      alert("Data entered. Please check your email for verification link.");
    } catch (error) {
        ...
        <center>
          <div class="form-container">
            <img
              ...
              class="image"
            />
            <p className='p2'>"Start your hostel journey with<br />
              a quick Login."</p>
            <form method="POST">
              ...
              <div class="input-group">
                ...
                className='em' aria-label="Email" name='email'
